...
#                self.fc2_c2 = fc(self.fc1_c2, 512, num = '2')
        ...
        with tf.variable_scope("channel3"):
            with tf.variable_scope("CNN_part"):
                with tf.variable_scope("cnn_m20Ds"):
                    self.conv1_c3 = conv(self.inputX, 20, 1, 20, 1, 1, '1', name = 'integration') #conv1 :[batch_size, seq_length, feat_num, 1]
                    self.bn1_c3 = bn(self.conv1_c3, self.is_training, '1')
                    self.relu1_c3 = tf.nn.relu(self.bn1_c3)
                with tf.variable_scope("cnn_3Ds"):
                    self.conv2_3_c3 = conv(self.relu1_c3, 3, self.config.feature_length, 1, self.config.feature_length, 20,'2_3')#conv2 :[batch_size, length, 1, channel]
                ...
                with tf.variable_scope("cnn_5Ds"):
                    self.conv2_5_c3 = conv(self.relu1_c3, 5, self.config.feature_length, 1, self.config.feature_length, 20,'2_5')#conv2 :[batch_size, length, 1, channel]
                ...
                with tf.variable_scope("cnn_9Ds"):
                    self.conv2_9_c3 = conv(self.relu1_c3, 9, self.config.feature_length, 1, self.config.feature_length, 20,'2_9')#conv2 :[batch_size, length, 1, channel]
